...
const TransactionResponse: React.FC<ExportDataProps> = (props) => {
  const { exportTransactionData } = useEasyActions((state) => state.monitor)
  ...
  const submitHandler = async () => {
    ...
    setIsLoading(true)
    const data = await exportTransactionData(params)
